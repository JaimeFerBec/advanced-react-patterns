...
I learnt how to use React Context to build a component that needs to share some variables with its children components, but does not know the depth at which they will be placed in the children component's tree.

It is great to put to use the concepts learnt about React Context in the previous course section (Advanced React Hooks) in a real world use case.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=03%3A%20Flexible%20Compound%20Components&em=jaime.ferbec%40gmail.com).
